...
class HttpClientsFactory
{
     ...
     * @throws InvalidArgumentException If the http client handler isn't "curl", "stream", or an instance of Facebook\HttpClients\FacebookHttpClientInterface.
     *
    ...
    public static function createHttpClient($handler)
    {
        ...
        throw new InvalidArgumentException('The http client handler must be set to "curl", "stream" or an instance of Facebook\HttpClients\FacebookHttpClientInterface');
    }
